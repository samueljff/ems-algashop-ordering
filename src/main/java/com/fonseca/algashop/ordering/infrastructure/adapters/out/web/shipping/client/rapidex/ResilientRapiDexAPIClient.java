package com.fonseca.algashop.ordering.infrastructure.adapters.out.web.shipping.client.rapidex;
...
import static com.fonseca.algashop.ordering.infrastructure.config.resilience.SpringCircuitBreakerConfig.rapidexAPICBId;
...
public class ResilientRapiDexAPIClient {
    ...
    private DeliveryCostResponse doInternalFallback(DeliveryCostRequest request, Throwable exTthrowable) {
        log.warn("Rapidex API failed for request {}", request, exTthrowable);
