...
class CustomerQueryServiceIT extends AbstractApplicationIT {
    ...
    void shouldFilterCustomersByFirstNameIgnoringCase() {
        ...
        Page<CustomerSummaryOutput> result = forQueryingCustomers.filter(filter);
    ...
    void shouldReturnCorrectNumberOfElements() {
        ...
        Page<CustomerSummaryOutput> page0 = forQueryingCustomers.filter(filterPage0);

        // segunda página (10 elementos)
        CustomerFilter filterPage1 = new CustomerFilter(10, 1);
        Page<CustomerSummaryOutput> page1 = forQueryingCustomers.filter(filterPage1);

        // terceira página (5 elementos restantes)
        CustomerFilter filterPage2 = new CustomerFilter(10, 2);
        Page<CustomerSummaryOutput> page2 = forQueryingCustomers.filter(filterPage2);
